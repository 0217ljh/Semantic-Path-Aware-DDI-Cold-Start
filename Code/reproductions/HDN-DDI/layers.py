"""HDN-DDI: byte-exact port of jcsun-00/HDN-DDI/drugbank_test/layers.py

Original source: https://github.com/jcsun-00/HDN-DDI/blob/main/drugbank_test/layers.py
...
class RESCAL(nn.Module):
    """Compute interaction score from drug head, drug tail, and relation rel."""
...
class IntraGraphAttention(nn.Module):
    """Single-layer GAT learning the per-drug molecular graph."""
...
class InterGraphAttention(nn.Module):
    """Single-layer GAT on the two-drug bipartite graph."""
