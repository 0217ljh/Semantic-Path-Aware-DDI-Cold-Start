...
def links2subgraphs(A, graphs, params, max_label_value=None):
    ...
    # lmdb-2.x port: map_size must be an int (older lmdb accepted floats). Add a
    # generous headroom factor + a 512 MB floor so the 100-sample size estimate can't
    # underflow into MDB_MAP_FULL (map_size is virtual address space, cheap).
